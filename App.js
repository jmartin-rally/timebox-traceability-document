...
Ext.define('CustomApp', {
                    ...
                    if ( summary.get("ParentID") === 0 ) {
				        ...
				        Ext.Array.each(children, function(child) {
				            ...
				            Ext.Array.each(test_cases, function(test_case) {         
	                            rows.push({ Label: prefix + 'Test Case:', Value: test_case.FormattedID + ": " + test_case.Name });
					            rows.push({ Label: prefix + prefix + 'Story:', Value: child.FormattedID + ": " + child.Name });
					            rows.push({ Label: prefix + prefix +  'Test Case Description:', Value: test_case.Description });
    ...
    _printWindow: function() {
        ...
        print_window.document.write('<style type="text/css">');
            print_window.document.write( '@media print {' );
            print_window.document.write('table { page-break-after:auto }');
            print_window.document.write(' tr    { page-break-inside:avoid; page-break-after:auto }');
            print_window.document.write('div   { page-break-inside:avoid; page-break-after:auto }');
            print_window.document.write('.x-grid-table tr td { page-break_inside: avoid; }');
            print_window.document.write( '}' );
            print_window.document.write('.x-grid-table { page-break-after:auto }');
            print_window.document.write('.x-grid-row    { page-break-inside:avoid; page-break-after:auto }');
            print_window.document.write('.x-grid-cell-inner    { page-break-inside:avoid; page-break-after:auto }');
            print_window.document.write('.x-grid-table tr td { page-break_inside: avoid; }');
